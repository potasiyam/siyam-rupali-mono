...
$fontDst = "$env:LOCALAPPDATA\Microsoft\Windows\Fonts\SiyamRupaliMono-007.ttf"
Copy-Item 'F:\project\siyam-rupali-mono\build\SiyamRupaliMono-007.ttf' $fontDst -Force
...
Capture 'WindowsTerminal' 'F:\project\siyam-rupali-mono\build\cap007_wt.png'
...
Move-Item 'F:\project\siyam-rupali-mono\build\term_probe_results.txt' 'F:\project\siyam-rupali-mono\build\results007_wt.txt' -Force -ErrorAction SilentlyContinue
...
Capture 'wezterm-gui' 'F:\project\siyam-rupali-mono\build\cap007_wezterm.png'
Get-Content 'F:\project\siyam-rupali-mono\build\term_probe_results.txt' -Encoding utf8 -ErrorAction SilentlyContinue | Select-Object -First 11
Move-Item 'F:\project\siyam-rupali-mono\build\term_probe_results.txt' 'F:\project\siyam-rupali-mono\build\results007_wezterm.txt' -Force -ErrorAction SilentlyContinue
...
Capture 'alacritty' 'F:\project\siyam-rupali-mono\build\cap007_alacritty.png'
Get-Content 'F:\project\siyam-rupali-mono\build\term_probe_results.txt' -Encoding utf8 -ErrorAction SilentlyContinue | Select-Object -First 11
Move-Item 'F:\project\siyam-rupali-mono\build\term_probe_results.txt' 'F:\project\siyam-rupali-mono\build\results007_alacritty.txt' -Force -ErrorAction SilentlyContinue
Write-Host "ALL DONE"
